...
export default () => {
  ...
  <head>
    ...
    <% if (assets.version) { %><link rel="stylesheet" type="text/css" href="https://raw.githubusercontent.com/abbaspour/auth0-sso-dashboard-extension/dist/auth0-sso-dashboard-authz.ui.<%= assets.version %>.css" /><% } %>
  ...
  <body>
    ...
    <% if (assets.version) { %>
    <script type="text/javascript" src="https://raw.githubusercontent.com/abbaspour/auth0-sso-dashboard-extension/dist/auth0-sso-dashboard-authz.ui.vendors.<%= assets.version %>.js"></script>
    <script type="text/javascript" src="https://raw.githubusercontent.com/abbaspour/auth0-sso-dashboard-extension/dist/auth0-sso-dashboard-authz.ui.<%= assets.version %>.js"></script>
    <% } %>
  </body>
  </html>
  `;
